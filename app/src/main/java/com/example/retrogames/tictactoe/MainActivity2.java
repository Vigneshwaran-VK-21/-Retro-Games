package com.example.retrogames.tictactoe;
...
//tic tac toe
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      TextView lb1 = findViewById(R.id.button1);
      TextView lb2 = findViewById(R.id.button2);
      TextView lb3 = findViewById(R.id.button3);
      TextView lb4 = findViewById(R.id.button4);
      TextView lb5 = findViewById(R.id.button5);
      TextView lb6 = findViewById(R.id.button6);
      TextView lb7 = findViewById(R.id.button7);
      TextView lb8 = findViewById(R.id.button8);
      TextView lb9 = findViewById(R.id.button9);
